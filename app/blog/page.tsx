...
export const metadata: Metadata = {
  title: "Blog - PromptDeal",
  description:
    "Learn about AI prompts, prompt engineering, and how to maximize your results with ChatGPT, Midjourney, and other AI tools.",
}
    ...
    <div className="min-h-screen bg-background">
      <section className="py-20 px-4 border-b border-border">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-balance">PromptDeal Blog</h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {posts.map((post) => (
              <article
                key={post.id}
                className="border border-border rounded-xl overflow-hidden hover:shadow-lg hover:shadow-primary/10 hover:border-primary/50 transition group"
              >
                ...
                <div className="p-6">
                  ...
                  <h2 className="text-xl font-bold mb-3 group-hover:text-primary transition text-balance">
                    {post.title}
                  </h2>
                  <p className="text-muted-foreground mb-4 text-sm text-pretty">{post.excerpt}</p>
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Subscribe to our newsletter for exclusive prompts, tutorials, and strategies delivered to your inbox.
          </p>
