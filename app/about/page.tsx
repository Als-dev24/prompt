...
export const metadata: Metadata = {
  title: "About Us - PromptDeal",
  description:
    "Learn about PromptDeal's mission to revolutionize digital marketing with premium AI prompts. Pay with crypto, download instantly.",
}
